...
servo HATCH     -> 90deg = closed / 120deg = opened (90deg + 30deg)
--------------------------------------------*/
...
#define paraDelay 2300 //parachute deployment delay in seconds
//ADAPT THE LOOP FREQUENCY HERE :
#define LoopMAXTime 12500 //loop time in µs (microseconds)(here 12500µs = 0.0125s -> 80Hz loop)
...
#define Tpid 0.0125 //sets the delay in seconds for calculation of discret integrals in PID (here 0.0125s=>80Hz)
