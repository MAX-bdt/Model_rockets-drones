...
#define paraDelay 1800 //parachute deployment delay in seconds
...
int32_t x3=0,b3=0,b6=0,p=0;
uint32_t b4=0,b7=0;
//define variables for pressure reading
uint8_t baroCounter=0;
long up=0;
uint32_t pressure=0;
float altitudeBarometer=0;
float initialAltitude=0;
float realAltitudeBarometer=0;
float inpow=0;
...
int32_t getReadings(uint8_t sensor, uint8_t adress, uint8_t size_data);//UTILS       
